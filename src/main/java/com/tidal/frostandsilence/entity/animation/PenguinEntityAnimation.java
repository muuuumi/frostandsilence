package com.tidal.frostandsilence.entity.animation;// Save this class in your mod and generate all required imports
...
public class PenguinEntityAnimation {
	public static final AnimationDefinition PenguinDashEnter = AnimationDefinition.Builder.withLength(1.0F).looping()
		...
		.addAnimation("penguin", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.0417F, KeyframeAnimations.posVec(0.0F, 0.67F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.0833F, KeyframeAnimations.posVec(0.0F, 1.25F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.125F, KeyframeAnimations.posVec(0.0F, 1.73F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.1667F, KeyframeAnimations.posVec(0.0F, 2.09F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.2083F, KeyframeAnimations.posVec(0.0F, 2.33F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.25F, KeyframeAnimations.posVec(0.0F, 2.43F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.2917F, KeyframeAnimations.posVec(0.0F, 2.36F, 0.0F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("left2", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.0F, KeyframeAnimations.degreeVec(5.0F, 5.0F, -47.5F), AnimationChannel.Interpolations.LINEAR)
		))
	...
	public static final AnimationDefinition PenguinDash = AnimationDefinition.Builder.withLength(1.0F).looping()
		.addAnimation("penguin", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
		...
		.addAnimation("left2", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(5.0F, 5.0F, -47.5F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(5.0F, 5.0F, -35.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.0F, KeyframeAnimations.degreeVec(5.0F, 5.0F, -47.5F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("right2", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(5.0F, -5.0F, 47.5F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(5.0F, -5.0F, 40.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.0F, KeyframeAnimations.degreeVec(5.0F, -5.0F, 47.5F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
	...
	public static final AnimationDefinition PenguinDashExit = AnimationDefinition.Builder.withLength(1.0F).looping()
		.addAnimation("penguin", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(90.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("penguin", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.4167F, KeyframeAnimations.posVec(0.0F, -2.11F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.625F, KeyframeAnimations.posVec(0.0F, -0.36F, 0.0F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition PenguinIdle = AnimationDefinition.Builder.withLength(2.0F).looping()
		.addAnimation("legs", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition PenguinWaddle = AnimationDefinition.Builder.withLength(3.0F).looping()
		.addAnimation("penguin", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -5.0F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("left", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(2.0F, KeyframeAnimations.posVec(0.0F, 0.5F, -0.5F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition PenguinAttack = AnimationDefinition.Builder.withLength(1.5F).looping()
		.addAnimation("legs", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition PenguinEat = AnimationDefinition.Builder.withLength(1.5F).looping()
		.addAnimation("upper", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
